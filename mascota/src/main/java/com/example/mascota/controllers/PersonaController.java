...
import com.example.mascota.entities.Persona;
import com.example.mascota.services.PersonaService;
...
public class PersonaController {
    ...
    public ResponseEntity<?> getAll(){
        try {
            return ResponseEntity.status(HttpStatus.OK).body(personaService.finalAll());
        }catch (Exception e){
